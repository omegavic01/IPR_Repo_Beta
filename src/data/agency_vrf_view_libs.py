...
class _LibraryBase:
    ...
    def get_command(self, command):
        ...
        self.client.connect(self.env_cls.tody_cools(),
...
class BuildLibraries(_LibraryBase):
    ...
    def run_build_libraries(self):
        ...
        self.build_vrf_and_view_mappings(ipam_network_views,
                                         vrf_to_agency_dict)
    ...
    def build_global_address_mapping(self):
        ...
        addr_file = os.path.join(self.dir_cls.raw_dir(),
        ...
        addr_data = {addr_line[0].strip(): {'site_name': addr_line[1],
                                            'city': addr_line[2],
                                            'country': addr_line[3],
                                            'region': addr_line[4],
